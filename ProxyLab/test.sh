...
DOWNLOAD_FILE="home.html"

echo "Downloading ${DOWNLOAD_FILE} through proxy"
download_proxy $PROXY_DIR ${DOWNLOAD_FILE} "http://localhost:${tiny_port}/${DOWNLOAD_FILE}" "http://localhost:${proxy_port}"
